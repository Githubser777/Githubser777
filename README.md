...
-- Page d'ex̩cution du script (ScriptFrame)
...
-- Gestionnaires d'̩v̩nements pour les boutons Tab 1, Tab 2, Tab 3
...
-- Page de r̩glage de vitesse (SpeedPageFrame)
...
-- Gestionnaire d'̩v̩nements pour le bouton CloseButton
